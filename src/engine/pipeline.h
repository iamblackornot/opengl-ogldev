...
public:
	...
	glm::mat4 GetViewTransform(Camera const& camera) const;
	glm::mat4 GetWPTransform() const;
	glm::mat4 GetWVPTransform(Camera const& camera) const;
private:
	...
	glm::mat4 GetChangeBasisTransform(Camera const& camera) const;
